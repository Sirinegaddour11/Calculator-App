      ...
      <div className={`max-w-md w-full bg-${theme === "light" ? "white" : "gray-700"} rounded-xl shadow-lg p-6`}>
        ...
        <div className="grid grid-cols-5 gap-2">
          ...
          {["x!", "inv", "sin", "ln", "π"].map((value, index) => (
            <button
              key={index}
              className="p-3 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 text-lg font-medium transition-colors"
          ...
          {["cos", "tan", "Ans", "e", "log"].map((func, index) => (
            <button
              key={index}
              className="p-3 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 text-lg font-medium transition-colors"
        ...
        <button
          className="mt-4 w-full p-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 text-xl font-bold transition-colors"
