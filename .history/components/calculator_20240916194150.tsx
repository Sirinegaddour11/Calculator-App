...
const Calculator: React.FC = () => {
  ...
  return (
    <div
      className={`flex justify-center items-center min-h-screen bg-${
        ...
        <div className="grid grid-cols-5 gap-2">
          ...
          {["x!", "inv", "sin", "ln", "π"].map((value, index) => (
            <button
              ...
              } rounded-lg hover:bg-blue-200 text-lg font-medium transition-colors`}
          ...
          {["cos", "tan", "Ans", "e", "log"].map((func, index) => (
            <button
              ...
              } rounded-lg hover:bg-green-200 text-lg font-medium transition-colors`}
